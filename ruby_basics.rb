...
nums.sort.reverse.select { |x| x > 10 }

new_array = nums.sort.reverse.select { |x| x > 10 } # To STORE the new array
...
# Method that is executed when a new Class object is created...
...
class Person
    ...
    def family
        ...
        kids.each { |x| puts x.name } # Missing comma between names; .join{", ") method does not work
    end
...
# ??..Classes have 54 default methods
